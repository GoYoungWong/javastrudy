...
public class StudentTest1 {
	...
	public static void main(String[] args) {
		...
		1) Stack Area  2) Heap Area  3) Method Area(Static Area) 암기★
		 ...
		 Heap Area : 클래스로 객체를 선언하고 실행이 될떄 이 영역에 기억장소가 생성
		...
		*/
		...
		// 생성된 기억장소에서 앞으로 힙영역에 생성될 주소가 저장된다.
		// 예> Person ps1;    ps1객체에 null 이 초기값으로 갖게된다.
		int a = 10; // stack area(스택영역)
		char c= '가'; // stack area(스택영역)
		
		// 객체생성
		// new(메모리생성생상자)  : 힙영역의 공간에 메모리(기억장소)를 생성하는 연산자.
		Student stu1 = new Student(); // 생성자
		stu1.studentName = "홍로로";
		
		Student stu2 = new Student();
		stu2.studentName = "이이이이";
		
		// chapter5.classpart2.Student@75a1cd57 : 페키지명.클래스명@주소값
		// 주소값을 해시코드(hash code)값이라고도 한다.
		
	    System.err.println(stu1); // chapter5.classpart2.Student@75a1cd57
	    System.err.println(stu2); // chapter5.classpart2.Student@515f550a
